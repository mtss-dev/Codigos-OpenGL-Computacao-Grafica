/*
19 - Modique o programa do Exercício anterior para que o quadrado adicional-
mente "pulse"à medida que se move ao longo do seu caminho. Isto é, para
cada revolução que faz sobre sobre seu próprio centro, o quadrado deve passar
por um ciclo de pulso que começa com o quadrado em seu tamanho original
que reduz suavemente em tamanho até 50% do seu tamanho original até o nal
do ciclo. Faça isso usando apenas o básico das Transformações geométricas do
OpenGL.
*/

// Como compilar: g++ 19.cpp -o 19 -lstdc++ -lGL -lglut -lGLU
// Para executar: ./19
