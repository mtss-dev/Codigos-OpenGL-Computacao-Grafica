/*
17 - Modique o programa do Exercício anterior para que o quadrado gire no sen-
tido horário em torno de seu próprio centro ao longo de seu caminho. O
quadrado deve completar uma revolução em torno de seu centro para cada
quarto de seu caminho ao redor da janela que ele completa. Usar apenas
transformações geométricas básicas do OpenGL para fazer isto.
*/

// Como compilar: g++ 17.cpp -o 17 -lstdc++ -lGL -lglut -lGLU
// Para executar: ./17
