/*
18 - Repita o exercício anterior usando as operações matriciais da OpenGL.
*/

// Como compilar: g++ 18.cpp -o 18 -lstdc++ -lGL -lglut -lGLU
// Para executar: ./18
...
void drawSquare() {
    ...
    // Cria a matriz de transformação de translação para o caminho circular
    glPushMatrix();
    glTranslatef(x, y, 0.0);

    // Cria a matriz de transformação de rotação para o quadrado
